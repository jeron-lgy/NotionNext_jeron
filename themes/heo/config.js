const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'jeron.life' },
    { title: '访问文档中心获取更多帮助', url: 'https://www.behance.net/jeronli/appreciated' }
  ],

  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '个人练习',
  HEO_HERO_TITLE_2: '与项目案例',
  HEO_HERO_TITLE_3: 'jeron.life',
  HEO_HERO_TITLE_4: '欢迎欢迎',
  HEO_HERO_TITLE_5: '不知道该改什么的占位符',
